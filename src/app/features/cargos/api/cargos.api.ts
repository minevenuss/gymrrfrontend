...
export class CargosApi{
  ...
  getAll(){
    return this.http.get<ApiResponse<Cargo[]>>(this.base + API_CONFIG.CARGOS.GET_ALL);
  }

  getById(id: number){
    return this.http.get<ApiResponse<Cargo[]>>(this.base + API_CONFIG.CARGOS.GET_BY_ID(id));
  }

  create(data: CreateCargoDto){
    return this.http.post<ApiResponse<Cargo[]>>(this.base + API_CONFIG.CARGOS.CREATE, data);
  }
  ...
  delete(id: number){
    return this.http.delete<ApiResponse<Cargo>>(this.base + API_CONFIG.CARGOS.DELETE(id));
  }
}
